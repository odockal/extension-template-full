                        ...
                        <div class="space-y-1 max-h-32 overflow-auto">
                          {#each runningContainers as c}
                            <Checkbox
                              ...
                              title={c.name}>
                              {#snippet children()}<span class="text-xs text-[var(--pd-content-text)]">{c.name}</span
                                >{/snippet}
                            </Checkbox>
                          {/each}
                        </div>
          ...
          <div class="w-full" role="table" aria-label="scenarios">
            ...
            <div role="rowgroup" class="space-y-2">
              {#each scenarios as scenario}
                <div
                  class="grid grid-cols-6 gap-x-2 min-h-[48px] items-center px-3 rounded-lg bg-[var(--pd-content-card-bg)] hover:bg-[var(--pd-content-card-hover-bg)] transition-colors"
                  role="row"
